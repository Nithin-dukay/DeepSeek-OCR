"""
Enhanced version of run_dpsk_ocr_image.py with command-line mode selection support.

Usage:
    python run_dpsk_ocr_image_with_mode.py --mode gundam
    python run_dpsk_ocr_image_with_mode.py --mode small
    python run_dpsk_ocr_image_with_mode.py --mode base --input path/to/image.jpg
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='DeepSeek-OCR vLLM Inference with Mode Selection',
...
Examples:
  ...
  python run_dpsk_ocr_image_with_mode.py --list-modes
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Custom prompt (overrides config.py PROMPT)'
    )
...
if __name__ == "__main__":
    ...
    print(f"=" * 60)
    print(f"Running DeepSeek-OCR with mode: {args.mode.upper()}")
    ...
    if '<image>' in prompt:
        # Use the mode-specific crop_mode setting
