...
async def stream_generate(image=None, prompt=''):
    ...
    # Key changes to prevent Triton/CUDA illegal memory access:
    # 1. enforce_eager=True - Disables CUDA graphs which cause memory issues
    # 2. gpu_memory_utilization=0.75 - Reduced from 0.9 to prevent fragmentation
    # 3. max_num_seqs=255 - Avoid power-of-2 values that trigger bugs
