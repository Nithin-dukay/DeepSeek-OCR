"""
Fixed version of run_dpsk_ocr_image.py with automatic vLLM version detection.

This script automatically detects the vLLM version and configures the environment
to prevent the "Engine core proc died" error (Issue #110).
"""
...
# IMPORTANT: Set up vLLM environment BEFORE importing torch and vLLM
from vllm_version_compat import setup_vllm_environment
setup_vllm_environment(force_v0=True, verbose=True)  # Force v0 for stability
