...
# CRITICAL FIX: Disable V1 engine to avoid Triton/CUDA memory issues
...
async def stream_generate(image=None, prompt=''):
    ...
    # ALTERNATIVE FIX: Using PIECEWISE CUDA graph mode
    # This approach keeps CUDA graphs enabled but uses a safer compilation mode
    # May provide better performance than enforce_eager=True
    # If this still causes issues, use the enforce_eager=True version instead
    ...
    engine_args = AsyncEngineArgs(
        ...
        compilation_config='{"cudagraph_mode": "PIECEWISE"}',  # CRITICAL FIX: Use piecewise mode
